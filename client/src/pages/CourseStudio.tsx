...
const steps: { id: Step; label: string; detail: string }[] = [
  ...
  { id: "curriculum", label: "Curriculum builder", detail: "Courses, modules, lessons" },
  { id: "lesson", label: "Lesson builder", detail: "Learning activity details" },
