...
const adminDomains = [
  { title: "Institution", links: [["University & settings", "/institution-settings"], ["Schools, departments & programmes", "/institutional-builder"], ["Institutional publication decisions", "/institutional-publication"], ["Academic Production Studio", "/admin/academic-production-studio"], ["Policy authorship & publication", "/policy-administration"], ["Calendar drafts & announcements", "/academic-tools"]] },
  { title: "Academics", links: [["Academic Production Studio", "/admin/academic-production-studio"], ["NIU AI Academic Builder", "/ai-academic-builder"], ["Assignment late-submission policy", "/assignment-policies"]] },
