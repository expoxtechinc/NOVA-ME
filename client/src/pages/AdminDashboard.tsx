...
const adminDomains = [
  ...
  { title: "People & records", links: [["Access, roles & permissions", "/access-control"], ["Existing users & course assignments", "/people-governance"], ["Grades & learning progress", "/grading"], ["Certificate eligibility & registry", "/registrar"], ["Credential correction & reissue", "/credential-reissue"], ["Credential history & verification", "/credential-history"]] },
