...
const adminDomains = [
  { title: "Institution", links: [["University & settings", "/institution-settings"], ["Schools, departments & programmes", "/institutional-builder"], ["Institutional publication decisions", "/institutional-publication"], ["Guided programme packages", "/programme-package"], ["Bundle readiness & publication", "/programme-publication"], ["Policy authorship & publication", "/policy-administration"], ["Calendar drafts & announcements", "/academic-tools"]] },
  { title: "Academics", links: [["NIU AI Academic Builder", "/ai-academic-builder"], ["Programme Builder — create programme", "/programme-builder"], ["Legacy course authoring", "/authoring"], ["Legacy modules, lessons & notes", "/institutional-builder"], ["Content & media library", "/content-library"], ["Question banks & assessments", "/assessment-builder"], ["Assignment late-submission policy", "/assignment-policies"]] },
