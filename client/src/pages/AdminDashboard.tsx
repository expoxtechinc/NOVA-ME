...
const adminDomains = [
  { title: "Institution", links: [["University & settings", "/institution-settings"], ["Schools, departments & programmes", "/institutional-builder"], ["Institutional publication decisions", "/institutional-publication"], ["Academic Production Studio", "/admin/academic-production-studio"], ["Bundle readiness & publication", "/programme-publication"], ["Policy authorship & publication", "/policy-administration"], ["Calendar drafts & announcements", "/academic-tools"]] },
