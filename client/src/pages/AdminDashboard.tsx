...
const adminDomains = [
  ...
  { title: "Academics", links: [["Course Studio — create programme", "/course-studio"], ["Legacy course authoring", "/authoring"], ["Legacy modules, lessons & notes", "/institutional-builder"], ["Content & media library", "/content-library"], ["Question banks & assessments", "/assessment-builder"], ["Assignment late-submission policy", "/assignment-policies"]] },
