...
const adminDomains = [
  { title: "Institution", links: [["University & settings", "/institution-settings"], ["Schools, departments & programmes", "/institutional-builder"], ["Guided programme packages", "/programme-package"], ["Bundle readiness & publication", "/programme-publication"], ["Calendar, policies & announcements", "/academic-tools"]] },
