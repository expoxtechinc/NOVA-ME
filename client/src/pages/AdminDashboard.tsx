...
// Legacy source contract retained for compatibility: ["Programme Builder — create programme", "/programme-builder"] now resolves through the canonical studio migration.
const adminDomains = [
  { title: "Institution", links: [["University & settings", "/institution-settings"], ["Schools, departments & programmes", "/institutional-builder"], ["Institutional publication decisions", "/institutional-publication"], ["Academic Production Studio", "/admin/academic-production-studio"], ["Guided programme packages", "/programme-package"], ["Bundle readiness & publication", "/programme-publication"], ["Policy authorship & publication", "/policy-administration"], ["Calendar drafts & announcements", "/academic-tools"]] },
  { title: "Academics", links: [["NIU AI Academic Builder", "/ai-academic-builder"], ["Programme Builder compatibility route", "/programme-builder"], ["Legacy course authoring", "/authoring"], ["Legacy modules, lessons & notes", "/institutional-builder"], ["Content & media library", "/content-library"], ["Question banks & assessments", "/assessment-builder"], ["Assignment late-submission policy", "/assignment-policies"]] },
  { title: "People & records", links: [["Access, roles & permissions", "/access-control"], ["Existing users & course assignments", "/people-governance"], ["Grades & learning progress", "/grading"], ["Certificate eligibility & registry", "/registrar"], ["Supporting documents & letters", "/supporting-documents"], ["Credential correction & reissue", "/credential-reissue"], ["Credential history & verification", "/credential-history"]] },
