...
const adminDomains = [
  ...
  { title: "Academics", links: [["NIU AI Academic Builder", "/ai-academic-builder"], ["Course Studio — create programme", "/course-studio"], ["Legacy course authoring", "/authoring"], ["Legacy modules, lessons & notes", "/institutional-builder"], ["Content & media library", "/content-library"], ["Question banks & assessments", "/assessment-builder"], ["Assignment late-submission policy", "/assignment-policies"]] },
